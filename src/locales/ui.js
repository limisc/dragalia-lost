const ui = {
  ...
  // element
  element_1: { en: 'Flame', ja: '火', zh: '火' },
  element_2: { en: 'Water', ja: '水', zh: '水' },
  element_3: { en: 'Wind', ja: '風', zh: '风' },
  element_4: { en: 'Light', ja: '光', zh: '光' },
  element_5: { en: 'Shadow', ja: '闇', zh: '暗' },
  // weapon
  weapon_1: { en: 'Sword', ja: '剣', zh: '剑' },
  weapon_2: { en: 'Blade', ja: '刀', zh: '刀' },
  weapon_3: { en: 'Dagger', ja: '短剣', zh: '短剑' },
  weapon_4: { en: 'Axe', ja: '斧', zh: '斧' },
  weapon_5: { en: 'Lance', ja: '槍', zh: '枪' },
  weapon_6: { en: 'Bow', ja: '弓', zh: '弓' },
  weapon_7: { en: 'Wand', ja: 'ロッド', zh: '魔杖' },
  weapon_8: { en: 'Staff', ja: '杖', zh: '法杖' },
  // target
